...
export declare type ThanosDAppRequest = ThanosDAppPermissionRequest | ThanosDAppOperationRequest | ThanosDAppSignRequest | ThanosDAppBroadcastRequest;
export declare type ThanosDAppResponse = ThanosDAppPermissionResponse | ThanosDAppOperationResponse | ThanosDAppSignResponse | ThanosDAppBroadcastResponse;
...
export declare type ThanosDAppNetwork = "mainnet" | "carthagenet" | "labnet" | "sandbox" | {
    name: string;
    rpc: string;
};
